...
class search_web_page:
    ...
    def request( self, *p, **d ):
        ...
        d.setdefault( 'url', 'http://www.mr.gov.il/OfficesTenders/Pages/SearchOfficeTenders.aspx' )
    ...
    def get_options( self, option_name ):
        if option_name == 'publisher':
            return [int(e.xpath('@value')[0].extract()) for e in self.must_exist_xpath( '//*[@id="ctl00_m_g_7b9ec4d5_a2ee_4fc4_8523_cd0a65f2d290_ctl00_ddlPublisher"]/option' ) if int(e.xpath('@value')[0].extract()) != 0]
        else:
            raise NotImplementedError()

    def option_value( self, option_name, option_index ):
        if option_name == 'publisher':
            ret = self.must_exist_xpath( '//*[@id="ctl00_m_g_7b9ec4d5_a2ee_4fc4_8523_cd0a65f2d290_ctl00_ddlPublisher"]/option[@value="%d"]/@title' % option_index  )
            if len(ret) != 1:
    ...
    def curr_page_num( self ):
        ...
        return int( self.must_exist_xpath( '//*[@id="ctl00_m_g_7b9ec4d5_a2ee_4fc4_8523_cd0a65f2d290_ctl00_grvMichrazim"]/tr[%d]/td/div/div/div[3]/span/text()' % (self.num_of_rows() + 2) )[0].extract() )
    ...
    def num_of_rows( self ):
        ...
        return len(self.sel.xpath( '//*[@id="ctl00_m_g_7b9ec4d5_a2ee_4fc4_8523_cd0a65f2d290_ctl00_grvMichrazim"]/tr' )) - d
    ...
    def validate_headings( self ):
        # titles
        # //*[@id="ctl00_m_g_7b9ec4d5_a2ee_4fc4_8523_cd0a65f2d290_ctl00_grvMichrazim"]/tbody/tr[1]/th

        start_time = time.time()

        for i, e in enumerate( self.must_exist_xpath( '//*[@id="ctl00_m_g_7b9ec4d5_a2ee_4fc4_8523_cd0a65f2d290_ctl00_grvMichrazim"]/tr[1]/th' ) ):
    ...
    def extract_page_urls( self ):
        ...
        for row_i in xrange(self.num_of_rows()):
            data_elems = self.must_exist_xpath( '//*[@id="ctl00_m_g_7b9ec4d5_a2ee_4fc4_8523_cd0a65f2d290_ctl00_grvMichrazim"]/tr[%d]/td' % (row_i+2) )
            if len(data_elems) != 7:
            ...
            url = self.must_exist_xpath( '//*[@id="ctl00_m_g_7b9ec4d5_a2ee_4fc4_8523_cd0a65f2d290_ctl00_grvMichrazim"]/tr[%d]/td[2]/a/@href' % (row_i+2) )[0].extract()
            if url.startswith( '/' ):
...
def test1():
    ...
    web_page = search_web_page( publisher_index=publishers[17] )
    result_indexes = web_page.result_indexes()
    print 'result_indexes', result_indexes
